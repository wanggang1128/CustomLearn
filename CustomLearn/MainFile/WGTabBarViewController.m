...
- (UINavigationController *)viewController:(UIViewController *)vc title:(NSString *)title nomalImg:(NSString *)imgStr tag:(NSInteger)tag{
    ...
    [item setTitleTextAttributes:[NSDictionary dictionaryWithObjectsAndKeys:UIColor.blueColor, NSForegroundColorAttributeName, nil] forState:UIControlStateSelected];
